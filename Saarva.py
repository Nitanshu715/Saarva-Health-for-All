...
def add_record(patient_id, date, doctor, prescription):
    record_doc = {
...
def show_add_record_dialog():
    ...
    if submitted:
        ...
        # --- Save to MongoDB and JSON together ---
        try:
            # Save to MongoDB
        ...
        st.success("💾 Backup saved to records.json")
